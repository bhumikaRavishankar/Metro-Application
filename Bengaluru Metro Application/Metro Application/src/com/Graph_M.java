...
public class Graph_M {
	...
	{
		System.out.println("\t Bengaluru Metro Map");
		System.out.println("\t------------------");
		System.out.println("----------------------------------------------------\n");
		ArrayList<String> keys = new ArrayList<>(vtces.keySet());
	...
	public static void Create_Metro_Map(Graph_M g)
	{
		...
		g.addVertex("Indiranagara");
		g.addVertex("Halasuru");
		g.addVertex("Trinity");
		g.addVertex("MG Road");
		g.addVertex("Cubbon Park Sri Chamarajendra Park");
		g.addVertex("Dr BR Ambedkar Vidhana Soudha");
		g.addVertex("Sir M. Visveshwaraya Station");
		g.addVertex("Nadaprabhu Kempegowda Station");
		g.addVertex("City Railway Station");
		g.addVertex("Magadi Road");
		g.addVertex("Balagangadhara Natha Swamiji HOS");
		g.addVertex("Vijayanagara");
		g.addVertex("Attiguppe");
		g.addVertex("Deepanjali Nagara");
		g.addVertex("Mysuru Road");
		g.addVertex("Nayandahalli");
		g.addVertex("Rajarajeshwari Nagar");
		g.addVertex("Jnanabharathi");
		g.addVertex("Pattanagere");
		g.addVertex("Kengeri Bus Terminal");
		g.addVertex("Kengeri");
		
		g.addEdge("Baiyappanhalli", "Swami Vivekananda Road", 2);
		g.addEdge("Swami Vivekananda Road", "Indiranagara", 2);
		g.addEdge("Indiranagara", "Halasuru", 2);
		g.addEdge("Halasuru", "Trinity", 1);
		g.addEdge("Trinity", "MG Road", 2);
		g.addEdge("MG Road", "Cubbon Park Sri Chamarajendra Park", 1);
		g.addEdge("Cubbon Park Sri Chamarajendra Park", "Dr BR Ambedkar Vidhana Soudha", 2);
		g.addEdge("Dr BR Ambedkar Vidhana Soudha", "Sir M. Visveshwaraya Station", 3);
		g.addEdge("Sir M. Visveshwaraya Station", "Nadaprabhu Kempegowda Station", 2);
		g.addEdge("Nadaprabhu Kempegowda Station", "City Railway Station", 1);
		g.addEdge("City Railway Station", "Magadi Road", 1);
		g.addEdge("Magadi Road", "Balagangadhara Natha Swamiji HOS", 2);
		g.addEdge("Balagangadhara Natha Swamiji HOS", "Vijayanagara", 3);
		g.addEdge("Vijayanagara", "Attiguppe", 2);
		g.addEdge("Attiguppe", "Deepanjali Nagara", 2);
		g.addEdge("Deepanjali Nagara", "Mysuru Road", 3);
		g.addEdge("Mysuru Road", "Nayandahalli", 2);
		g.addEdge("Nayandahalli", "Rajarajeshwari Nagar", 2);
		g.addEdge("Rajarajeshwari Nagar", "Jnanabharathi", 3);
		g.addEdge("Jnanabharathi", "Pattanagere", 2);
		g.addEdge("Pattanagere", "Kengeri Bus Terminal", 3);
		g.addEdge("Kengeri Bus Terminal", "Kengeri", 1);
	}
